...
if uploaded_files is None:
  ...
  #extract embeddings
  embeddings = OpenAIEmbeddings(openai_api_key = "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")
  #vstore with metadata. Here we will store page numbers.
  vStore = Chroma.from_texts(documents, embeddings, metadatas=[{"source": s} for s in sources])
  #deciding model
  model_name = "gpt-3.5-turbo-instruct"
  # model_name = "gpt-4"
  #os.environ["openai_api_key"] ="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"

  retriever = vStore.as_retriever()
  retriever.search_kwargs = {'k':2}

  #initiate model
  llm = OpenAI(openai_api_key = "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", model_name=model_name, streaming=True)
